...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length =30, default="+2348140117832" )
    about_me =models.TextField(verbose_name=_("About me"), default="say something baout yourself")
    ...
    country = CountryField(verbose_name =("Country"), default= "KE", blank=False, null= True)
